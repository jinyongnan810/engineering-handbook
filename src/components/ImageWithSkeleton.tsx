  ...
  return (
    ...
    >
      ...
      {!isLoaded && !hasError && (
        ...
        >
          <div className="flex h-12 w-12 items-center justify-center rounded-full bg-neutral-300/60 text-neutral-400 dark:bg-neutral-700/60 dark:text-neutral-500">
            <svg
              className="h-6 w-6"
              fill="none"
              stroke="currentColor"
          ...
          <div className="h-2.5 w-32 rounded-full bg-neutral-300/80 dark:bg-neutral-700/80" />
        </div>
      )}
